...
#[ConfigEntityType(
  ...
  label: new TranslatableMarkup('Variation Bundle type'),
  label_collection: new TranslatableMarkup('Variation Bundle types'),
  label_singular: new TranslatableMarkup('variation bundle type'),
  label_plural: new TranslatableMarkup('variation bundle types'),
  label_count: [
